...
export class UnavialabilityComponent implements OnInit {
  ...
  ngOnInit() {
    this.assignClinics = [];
    this.speciality = [];
    this.startDate = new Date(this.dayService.startDate);
    this.endDate = new Date(this.dayService.startDate);
    this.minDate = new Date(this.startDate);
    this.startTime = new Date(this.dayService.startDate);
    this.endTime = new Date(this.dayService.startDate)
  ...
  constructor(
    ...
    public daySubjectService: MonthSubjectService) {
    this.createForm();
  ...
  public submitFormAndOpen() {
    ...
    if (this.endTime.getTime() <= this.minTime.getTime()) {
      ...
      this.object.startDate = this.startDate;
      this.object.endDate = this.endDate;
