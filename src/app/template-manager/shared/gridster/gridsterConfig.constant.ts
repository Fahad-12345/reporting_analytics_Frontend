import { DisplayGrid, GridsterConfig, GridType } from './gridsterConfig.interface';
export const GridsterConfigService: GridsterConfig = {
	...
	disableAutoPositionOnConflict: true, // disable auto-position of items on conflict state
};
