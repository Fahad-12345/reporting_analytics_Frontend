...
export class ProviderComponent extends PermissionComponent implements OnInit {

	userPermissions = USERPERMISSIONS;


    constructor(aclService: AclService, router: Router, protected requestService: RequestService,	private route: ActivatedRoute, ) { 
