...
const envIntial = "ovadamd.com";
const serverIntial = `autoscaling.cm.${envIntial}`;
const billingIntial = `autoscaling.billing.${envIntial}`;
const healthIntial = `autoscaling.health.${envIntial}`;
const templateMangerIntial = `autoscaling.tm.${envIntial}`;
const socketIntial = `autoscaling.socket.${envIntial}`
