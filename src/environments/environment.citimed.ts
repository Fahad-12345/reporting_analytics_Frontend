...
export const environment: { [task_mngr_api_dev: string]: any } = {
	...
	billing_api_url: 'https://citimed.billing.ovadamd.com/api/',
	...
	md_api_url: 'https://citimed.md.ovadamd.com/api/',
	schedulerApiUrl: 'https://citimed.cm.ovadamd.com/api/sch',
	whitelistedDomains: ['localhost', '*.ovadamd.org', '*.ovadamd.com'],
	kiosk_api_path: 'https://citimed.rk.ovadamd.com/api/', //'https://kiosk.ovadamd.org/api/',
	// kiosk_api_path: 'https://cm.ovadamd.net/api/',
	schedular_api_path: 'https://citimed.cm.ovadamd.com/api/sch/',
	document_mngr_api_path: 'https://citimed.cm.ovadamd.com/api/dm/',
	userManagementUrl: 'https://citimed.fd.ovadamd.com/api',
	billing_api_path: 'https://citimed.billing.ovadamd.com/api/',
