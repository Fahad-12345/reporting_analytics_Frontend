...
export const environment: { [task_mngr_api_dev: string]: any } = {
	...
	billing_api_url: 'https://citimed-bk.billing.ovadamd.tk/api/',
	// fd_api_url: "https://revampfd.ovadamd.tk/api/",
	fd_api_url: 'https://citimed-bk.cm.ovadamd.tk/api/',
	fd_api_url_vd: "https://citimed-bk.cm.ovadamd.tk/api/vd/",
	md_api_url: 'https://citimed-bk.md.ovadamd.tk/api/',
	schedulerApiUrl: 'https://citimed-bk.cm.ovadamd.tk/api/node/sch',
	schedulerApiUrl1: 'https://citimed-bk.cm.ovadamd.tk/api/node/sch',
	whitelistedDomains: ['localhost', '*.ovadamd.org', '*.ovadamd.com', '*.ovadamd.tk'],
	kiosk_api_path: 'https://citimed-bk.cm.ovadamd.tk/api/node/kiosk/',

	//'https://kiosk.ovadamd.org/api/',
	// kiosk_api_path: 'https://cm.ovadamd.net/api/',
	schedular_api_path: 'https://citimed-bk.cm.ovadamd.tk/api/node/sch',
	document_mngr_api_path: 'https://citimed-bk.cm.ovadamd.tk/api/dm/',
	userManagementUrl: 'https://citimed-bk.fd.ovadamd.tk/api',
	billing_api_path: 'https://citimed-bk.billing.ovadamd.tk/api/',
	// task_mngr_api_dev: 'https://localhost:3000/api',
	task_mngr_api_dev: 'https://citimed-bk.tm.ovadamd.tk/api',
	templateManagerUrl: 'https://citimed-bk.templateapi.ovadamd.tk/',
	...
	socketUrl: 'https://citimed-bk.socket.ovadamd.tk/',
